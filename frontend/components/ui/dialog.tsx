...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-[min(92vw,760px)] translate-x-[-50%] translate-y-[-50%] rounded-2xl border border-white/10 bg-slate-950 p-6 shadow-[0_40px_80px_rgba(0,0,0,0.35)]",
        className,
      )}
      {...props}
    >
